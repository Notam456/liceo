<?php
session_start();
include_once($_SERVER['DOCUMENT_ROOT'] . '/liceo/modulos/usuarios/model/usuarios_model.php');
...
class UsuariosController {
    ...
    public function index() {
        ...
        include_once($_SERVER['DOCUMENT_ROOT'] . '/liceo/modulos/usuarios/view/usuarios_view.php');
    }
