...
<body data-spy="scroll" data-target=".navbar" data-offset="70">
    ...
    <div id="mainContent">
        ...
        <?php if (isset($_GET['mensaje']) && $_GET['mensaje'] === 'inactividad'): ?>
            <div class="alert alert-warning text-center mt-3 dismissible" role="alert">
                La sesión fue cerrada debido a que pasaron 30 minutos sin actividad en el sistema
                <br>
                <button type="button" class="btn-close" data-dismiss="alert" aria-label="Close"></button>
            </div>
        <?php endif; ?>
