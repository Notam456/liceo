...
<body>
            ...
            <div class="col-md-8">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4>Materia <img src="/liceo/icons/people.svg">
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>No se encontraron registros de materias.</td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="editmodalLabel">Modificar Materia</h1>
    ...
    <div class="modal fade" id="insertdata" tabindex="-1" aria-labelledby="insertdataLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="insertdataLabel">Agregar una nueva materia</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
