...
<body>
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>No se encontraron asignaciones de materias.</td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="editmodalLabel">Modificar Asignación de Materia</h1>
                ...
                <form id="edit-form" action="/liceo/controladores/asigna_materia_controlador.php" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-3">
                            <label>Materia</label>
                            <select id="id_materia_edit" class="form-control" name="id_materia" required>
    ...
    <div class="modal fade" id="insertdata" tabindex="-1" aria-labelledby="insertdataLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="insertdataLabel">Nueva Asignación de Materia</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
